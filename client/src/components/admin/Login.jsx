        ...
        <div className='flex items-center justify-center h-screen'> 
            ...
            shadow-xl shadow-primary/15 rounded-1g'> 
                <div className='flex flex-col items-center justify-center'> 
                    ...
                    <p className='font-semibold text-gray-500'>Enter your credentials to access the admin panel</p> 
                </div> 
                <form onSubmit={handleSubmit} className='mt-6 w-full sm:max-w-md text-gray-700'> 
                    <div className='flex flex-col'> 
                        ...
                        <button type='submit' className='w-full py-3 mb-5 font-medium bg-primary text-white rounded cursor-pointer hover:bg-priary/90 transition-all'> Login </button>
                    </form>
            </div> 
        </div> 
    </div>
